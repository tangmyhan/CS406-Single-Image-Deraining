...
parser.add_argument('--train_dir', default='/kaggle/input/rain13kdataset/train/train/Rain13K/', type=str, help='Directory of train images')
parser.add_argument('--val_dir', default='/kaggle/input/rain13kdataset/test/test/Rain100H/', type=str, help='Directory of validation images')
...
parser.add_argument('--pretrain', action='store_true', help='Use pretrain weights')
parser.add_argument('--pretrain_weights', default='', type=str, help='Path to pretrain-weights')
parser.add_argument('--resume', action='store_true', help='Resume training from checkpoint')
parser.add_argument('--resume_ckpt', default='', type=str, help='Path to checkpoint to resume from')
# 
...
if args.pretrain:
    ...
    print('------------------------------------------------------------------------------')
    print("==> Retrain Training with: " + args.pretrain_weights)
    print('------------------------------------------------------------------------------')
...
######### DataLoaders ###########
train_dataset = get_training_data(train_dir, {'patch_size': patch_size}, subset_ratio=1.0)
